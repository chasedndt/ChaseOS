...
1. **Redaction-at-source (preventive)** — `runtime/studio/chat/redaction.py`.
   ...
   before it enters a payload. Shape-based: provider key prefixes (`sk-`, `test-key-ant-`,
...
Built-in bridges: Hermes, OpenClaw, Codex (`claude-code`), Archon, AOR. `emit`
