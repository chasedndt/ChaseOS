...
```text
browser run evidence -> skill candidate -> operator review -> active SiteOps skill card / workflow manifest
```
...
- active Site Skill Cards must live in the governed SiteOps registry
