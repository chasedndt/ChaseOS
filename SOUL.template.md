...
| `00_HOME/Assistant-Contract.md` | Binding operational rules — what agents can and cannot do, permission levels |
| `00_HOME/Principles.md` | Personal doctrine and decision rules — the user's own operating philosophy |
...
1. Read `00_HOME/Now.md` — what is in scope this sprint?
...
5. Reference `00_HOME/Assistant-Contract.md` if uncertain what you are allowed to do.

### Closing a Session

1. Write the build log directly to `07_LOGS/Build-Logs/` — agent-assisted writeback is the default. Prompt the user only if the write target is ambiguous or the session produced no meaningful output.
