...
1. Create a new entry in `07_LOGS/Build-Logs/` using the naming format:
   ```
   YYYY-MM-DD-[Project]-[brief-descriptor].md
   ```
   Example: `2026-03-18-TradeSync-scoring-engine-design.md`
...
## File Location
All build logs go in: `07_LOGS/Build-Logs/`
