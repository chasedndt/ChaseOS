...
### Definition
Protected files are those explicitly listed in `00_HOME/Assistant-Contract.md` and `06_AGENTS/Permission-Matrix.md`. Editing them requires explicit per-file user approval.
