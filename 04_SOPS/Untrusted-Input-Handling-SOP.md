...
- Any automated promotion action must be logged in `07_LOGS/Agent-Activity/`
...
2. Prioritize triage by relevance to current sprint focus (`00_HOME/Now.md`)
...
| `07_LOGS/Agent-Activity/`              | Log for automated ingestion actions                                 |                                    |
