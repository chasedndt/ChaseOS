...
Architecture constraints (enforced):
  ...
  - Provider seam is thin: StubGenerationAdapter (local-first) or
    AnthropicGenerationAdapter (real Claude, requires ANTHROPIC_API_KEY).
...
class StubGenerationAdapter(GenerationAdapterBase):
    ...
    def generate(self, prompt: str, max_tokens: int = 2048) -> dict:
        stub_text = (
            ...
            "  3. Re-run -- the AnthropicGenerationAdapter will activate automatically.\n\n"
