...
ACTIVE_NOW_PROJECT_MAP: dict[str, str] = {
    ...
    "Trading Systems / Market Ops": "01_PROJECTS/TradingSystems/TradingSystems-OS.md",
    "StrikeZone Crypto": "01_PROJECTS/StrikeZone/StrikeZone-Crypto-OS.md",
    "University": "01_PROJECTS/University/Degree-OS.md",
}
