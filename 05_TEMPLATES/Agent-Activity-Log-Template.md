...
> Template for audit-significant or elevated non-build agent activity logs in `07_LOGS/Agent-Activity/`.
...
> For engineering/docs/architecture sessions, use the build log in `07_LOGS/Build-Logs/` instead.
> See `07_LOGS/Agent-Activity/Agent-Activity-Folder-Guide.md` for what belongs here vs build logs.
...
```
07_LOGS/Agent-Activity/YYYY-MM-DD-[agent]-[descriptor].md
```
...
*Agent activity log — see `07_LOGS/Agent-Activity/Agent-Activity-Folder-Guide.md` for folder conventions.*
...
| Situation | Log type |
|-----------|---------|
| Engineering or documentation build session | Build log in `07_LOGS/Build-Logs/` |
