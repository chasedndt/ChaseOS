...
- Codex and Archon are also bus-capable development runtimes, but the requested
  product-facing backend target is modeled as OpenHuman, HermesAgent, OpenClaw.
