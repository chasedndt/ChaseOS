---
title: ChaseOS Agent Runtime Contract v1
created: 2026-05-31
status: DRAFT / EARLY STANDARD / SUBJECT TO CHANGE
schema_name: chaseos.agent.json
type: standard-spec
---

# ChaseOS Agent Runtime Contract v1

Schema name: `chaseos.agent.json`

Defines runtime identity, provider class, capabilities, approval-required actions, hard blocks, logging, and audit posture.
