---
title: ChaseOS Approval Packet v1
created: 2026-05-31
status: DRAFT / EARLY STANDARD / SUBJECT TO CHANGE
schema_name: chaseos.approval.json
type: standard-spec
---

# ChaseOS Approval Packet v1

Schema name: `chaseos.approval.json`

Defines actions that require human permission: requester, action type, target, risk class, payload summary, review requirement, decision, expiry.
