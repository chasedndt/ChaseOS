---
title: ChaseOS Knowledge Graph Object v1
created: 2026-05-31
status: DRAFT / EARLY STANDARD / SUBJECT TO CHANGE
schema_name: chaseos.graph.json
type: standard-spec
---

# ChaseOS Knowledge Graph Object v1

Schema name: `chaseos.graph.json`

Defines graph nodes and edges for projects, packs, outputs, decisions, sources, approvals, and runtime evidence.
