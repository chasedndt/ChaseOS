...
The trust/permission tiers (read / write / modify core / delete) from `00_HOME/Assistant-Contract.md` should be preserved. You may adjust specific rules but should not remove the permission model entirely.
...
- `00_HOME/Principles.md` — your doctrine, your decision rules, not someone else's

**Operating system:**
- `00_HOME/Operating-System.md` — your domains, your projects, your tiers
- `00_HOME/Dashboard.md` — your status, your links, your system state
- `00_HOME/Now.md` — your current sprint priorities
- `00_HOME/Tech-Pillars.md` — your core technical disciplines (if applicable)
...
Write this out in `00_HOME/Operating-System.md` using the same format: a named domain list with a letter or number identifier, a short description, and the key projects or initiatives within each.
...
- `00_HOME/Principles.md` with your actual decision rules and operating doctrine
- `00_HOME/Dashboard.md` with your real domain links and status
...
Populate `00_HOME/Now.md` with what you are actually focused on right now.
...
- Audit every file in `00_HOME/`, `01_PROJECTS/`, `02_KNOWLEDGE/`, and `06_AGENTS/` for personal information
